...
import { Calendar, DollarSign, Receipt, Percent, Clock, FileText } from "lucide-react"
...
interface SpendingApprovalDetailModalProps {
...
export function SpendingApprovalDetailModal({
  request,
  open,
  onOpenChange,
  onApprove,
  onReject,
}: SpendingApprovalDetailModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-xl">Spending Request Details</DialogTitle>
        </DialogHeader>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex items-center">
                    ...
                    <span className="text-lg font-semibold">{formatAmount(request.amount)}</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex items-center">
                    ...
                    <span>{formatDate(request.receiptDate)}</span>
                  </div>
                </CardContent>
              </Card>
